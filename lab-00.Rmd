...
```{r setup-tibble}
team_data <- tibble(
  name = c("Emma", "Yankun", "member 2", 
           "member 3", "member 4"),
  github_username = c("taoran06", "shuangyk", "username 2", 
                      "username 3", "username 4"), 
  colour = c("blue", "blue", "colour 2", 
             "colour 3", "colour 4"),
  hobby = c("singing", "gaming", "hobby 2", 
            "hobby 3", "hobby 4"),
  favourite_number = c(3, 5, NA, NA, NA)
  )
